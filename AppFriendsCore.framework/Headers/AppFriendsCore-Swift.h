...
- (void)initializeWithKey:(NSString * _Nonnull)applicationKey secret:(NSString * _Nonnull)applicationSecret completion:(void (^ _Nullable)(BOOL, NSError * _Nullable))completion;
...
- (NSString * _Null_unspecified)videoStreamingURLWithPublicID:(NSString * _Nonnull)id SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Null_unspecified)videoThumbnailURLWithPublicID:(NSString * _Nonnull)id SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Null_unspecified)fullImageWithPublicID:(NSString * _Nonnull)id SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Null_unspecified)thumbnailImageWithPublicID:(NSString * _Nonnull)id SWIFT_WARN_UNUSED_RESULT;
