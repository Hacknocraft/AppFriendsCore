...
@interface HCSDKCore (SWIFT_EXTENSION(AppFriendsCore))
- (BOOL)isAppFriendsVideoURLWithUrl:(NSString * _Nonnull)url;
- (NSString * _Nonnull)videoStreamingURLWithPublicID:(NSString * _Nonnull)pid;
- (NSString * _Nonnull)videoThumbnailURLWithPublicID:(NSString * _Nonnull)pid;
- (NSString * _Nonnull)fullImageWithPublicID:(NSString * _Nonnull)pid;
- (NSString * _Nonnull)thumbnailImageWithPublicID:(NSString * _Nonnull)pid;
@end
